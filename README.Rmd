...
package enables code to be traced to see what types of parameters are actually
passed to R functions. `typetracer` can trace individual functions or entire
...
test, prefixed with "test_". Other than this column, the results are the same
as shown above for `load_traces()`, with one line for every parameter passed to
