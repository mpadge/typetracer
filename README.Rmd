...
package](https://docs.ropensci.org/autotest/), with all code from here included
directly in that package. Future development of this package will only be in
response to changes or bug fixes implemented in `autotest`.

If you see a direct use for this `typetracer` package, and would like to see it
released on CRAN, feel free to open an issue here, or contact @mpadge directly,
