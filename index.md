...
The following example includes four parameters, including `...` to allow
...
Each row of the result returned by
[`load_traces()`](https://mpadge.github.io/typetracer/reference/load_traces.md)
represents one parameter passed to one function call. Each function call
itself represents a single “trace” as enumerated by the `trace_number`
column, and also uniquely identified by an arbitrary function call hash
...
[`trace_package()`](https://mpadge.github.io/typetracer/reference/trace_package.md)
function includes three more columns than the result directly returned
by
[`load_traces()`](https://mpadge.github.io/typetracer/reference/load_traces.md).
