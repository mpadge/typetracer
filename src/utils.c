...
// See https://github.com/r-lib/covr/pull/587
...
SEXP reassign_function_body(SEXP old_fun, SEXP new_fun) {
    if (TYPEOF(old_fun) != CLOSXP) Rf_error("old_fun must be a function");
